...
sys.path.append(r'C:\Dev\scripting')
...
from SMBS.Shared.DataImport import Single_Input, PvtData, PvtDataRow, LabPVT, RockData, TankData
...
def create_single_input_from_excel(xlfile: str,
                                   tanksheet: str = "Tank",
                                   pvtsheet: str = "ExtPVT") -> Single_Input:
